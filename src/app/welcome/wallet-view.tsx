...
export function WalletView({ profile, paymentSettings }: { profile: any, paymentSettings: any }) {
    ...
    return (
        <div className="space-y-12 max-w-4xl mx-auto animate-in fade-in duration-500">
                    ...
                    <form onSubmit={handleTopUp} className="h-full flex flex-col">
                        ...
                        <CardContent className="space-y-5 flex-grow">
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Amount (₹)</Label>
                                ...
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-500">UTR / Transaction ID</Label>
                            ...
                            <div className="p-4 bg-black/20 rounded-xl border border-white/5 flex items-center justify-between">
                                <div className="space-y-1">
                                    <p className="text-[9px] font-bold text-gray-600 uppercase tracking-widest">Transfer To</p>
                                    <p className="font-mono text-white text-xs font-bold">{paymentSettings?.upi_id || 'payout@fundedstock'}</p>
                                </div>
                        ...
                        <CardFooter>
                            <Button type="submit" disabled={isPending || !amount || !utr} className="w-full h-12 font-bold uppercase tracking-widest bg-primary text-white rounded-xl shadow-xl shadow-primary/20 text-xs">
            ...
            <p className="text-center text-[9px] font-bold text-gray-700 uppercase tracking-[0.2em] mt-8">
                Verification: Manual Protocol Required · Est. 15-30m
            </p>
        </div>
    );
}
