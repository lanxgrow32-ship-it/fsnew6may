    ...
    return (
        <div className="space-y-8 max-w-4xl mx-auto">
            <div className="text-center space-y-4 mb-8">
                <h2 className="text-3xl font-extrabold text-white tracking-tight">Deposit Center</h2>
                <p className="text-gray-400 text-lg">Top up your wallet balance to purchase new protocols.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <GlassCard className="p-8 border-primary/20 bg-primary/5 h-full flex flex-col justify-center">
                    ...
                    <div className="mt-6 p-4 bg-white p-3 rounded-2xl shadow-2xl w-fit mx-auto md:mx-0">
                        {paymentSettings?.qr_code_url ? (
                            <Image src={paymentSettings.qr_code_url} alt="Topup QR" width={200} height={160} className="rounded-lg" />
                        ) : (
                            <div className="w-[200px] h-[200px] bg-slate-100 flex items-center justify-center text-slate-900 font-bold">SCAN & PAY</div>
                        )}
                    </div>
                </GlassCard>
            ...
            <p className="text-center text-xs text-gray-500 mt-8">
                Deposits are manually verified by our team. Approval typically takes 15-30 minutes during market hours.
            </p>
        </div>
    );
}