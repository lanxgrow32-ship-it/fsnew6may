...
export default async function AccountDashboardPage({ params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        // 1. SESSION CLEANUP: Check if account is expired (7-Day Pro or 48h Trial)
        ...
        if (fetchError || !account) notFound();

        // 3. Prevent access to expired sessions
        ...
        console.error("[Account Dashboard] Critical Error:", e);
        redirect('/welcome');
    }
}
