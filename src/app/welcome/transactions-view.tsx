            ...
            <Table>
                <TableHeader className="bg-white/5">
                    <TableRow className="border-white/5 hover:bg-transparent">
                        <TableHead className="text-gray-500 font-bold h-12 pl-6 text-xs">Transaction</TableHead>
                        <TableHead className="text-gray-500 font-bold h-12 text-xs">Date</TableHead>
                        <TableHead className="text-gray-500 font-bold h-12 text-xs">Reference</TableHead>
                        <TableHead className="text-gray-500 font-bold h-12 text-xs">Status</TableHead>
                        <TableHead className="text-right text-gray-500 font-bold h-12 pr-6 text-xs">Amount</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                            ...
                            <TableCell className="pl-6 py-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-gray-500 font-bold mt-1 capitalize">{tx.type}</p>
                                    </div>
                                </div>
                            </TableCell>
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <Tabs defaultValue="all" className="w-full">
                <TabsList className="bg-black/40 border border-white/10 p-1 rounded-2xl mb-8 h-auto flex flex-wrap gap-1 max-w-fit">
                    <TabsTrigger value="all" className="flex items-center gap-2 py-2 px-6 rounded-xl font-bold text-sm">
                        <History className="w-4 h-4"/> All
                    </TabsTrigger>
                    <TabsTrigger value="purchases" className="flex items-center gap-2 py-2 px-6 rounded-xl font-bold text-sm">
                        <ShoppingCart className="w-4 h-4"/> Purchases
                    </TabsTrigger>
                    <TabsTrigger value="deposits" className="flex items-center gap-2 py-2 px-6 rounded-xl font-bold text-sm">
                        <Wallet className="w-4 h-4"/> Deposits
                    </TabsTrigger>
                    <TabsTrigger value="bonuses" className="flex items-center gap-2 py-2 px-6 rounded-xl font-bold text-sm">
