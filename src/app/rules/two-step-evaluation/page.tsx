                    ...
                    <div className="max-w-4xl mx-auto space-y-8">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <DetailedRule title="Maximum Daily Loss" tag="5% of account" description="Losses in a single trading day cannot exceed 5% of your starting account balance. Daily loss is calculated from the account balance at the start of that trading day. Breaching this on any single day results in immediate account failure." tagVariant="destructive" />
                                <DetailedRule title="Maximum Overall Drawdown" tag="10% of account" description="Your account equity must never fall more than 10% below the initial starting balance at any point during the evaluation. This is tracked in real-time across all open and closed positions." tagVariant="destructive" />
                                ...
                                <DetailedRule title="News Trading Restriction" tag="±5 min window banned" description="Trading is prohibited 5 minutes before and 5 minutes after any major scheduled event — including RBI policy announcements, SEBI circulars, Union Budget, and company earnings results. You will receive an SMS and email alert 30 minutes before each such event. Trades placed within this window will be considered invalid." tagVariant="destructive" />
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <DetailedRule title="Maximum Daily Loss" tag="5% of account" description="The 5% daily loss rule remains unchanged in Phase 2. Consistent risk management across both phases is what separates funded traders from the rest." tagVariant="destructive" />
                                <DetailedRule title="Maximum Overall Drawdown" tag="10% of account" description="The overall drawdown limit remains 10% from the initial account balance. Your cumulative losses from day one of Phase 2 must not exceed this threshold at any point." tagVariant="destructive" />
                                ...
                                <DetailedRule title="Allowed Instruments" tag="All NSE/BSE segments" description="All instruments permitted in Phase 1 remain available — equity stocks, index & stock options (both buying and writing), and futures. No lot size restrictions apply." />
                         ...
                         <Card>
                            ...
                            <CardContent>
                                ...
                                <DetailedRule title="Max Daily Loss (Funded)" tag="5% of account" description="The 5% daily loss limit carries into your funded account. A single bad day beyond this threshold will trigger an automatic account suspension pending review. Protecting capital is the first priority of any funded trader." tagVariant="destructive" />
                                <DetailedRule title="Max Overall Drawdown (Funded)" tag="10% of account" description="The overall drawdown limit on live funded accounts is 10% from the original account balance. Breaching this results in immediate account termination with no reinstatement on the same account." tagVariant="destructive" />
                            ...
                            <CardContent>
                                <Accordion type="single" collapsible className="w-full">
                                    ...
                                    <FaqItem
                                        ...
                                        answer="Daily loss is calculated from your account balance at the start of that trading day — not from intraday peaks. For example, if your account opens a day at ₹5,00,000, you cannot lose more than ₹25,000 (5%) that day regardless of any profits made earlier in the session."
                                    />
                                    <FaqItem
                                        question="What happens if I breach a rule accidentally?"
                                        answer="Any hard limit breach results in immediate account failure. The system is automated — there are no manual overrides for evaluation accounts. For funded accounts, certain violations trigger a suspension and review."
                                    />
                                    <FaqItem
                                    ...
                                    <FaqItem
                                        ...
                                        answer="Trading is prohibited 5 minutes before and 5 minutes after major scheduled events. You will receive an automated SMS and email notification 30 minutes before each restricted window. A live calendar of upcoming restricted events is also available in your trader dashboard."
                                    />
                                    <FaqItem
                                        question="When exactly do I get my evaluation fee back?"
                                        answer="Your evaluation fee is fully refunded automatically with your 3rd successful payout. Each of the three payouts must meet both conditions: a minimum of 5 trading days in that cycle and a minimum profit of ₹2,000."
                                    />
                                    <FaqItem
                                        question="Is a stop loss mandatory during the evaluation phases too?"
                                        answer="No. The mandatory stop loss rule applies only to the live funded account. During Phase 1 and Phase 2, you are free to manage your trades without a hard stop loss. However, given the risk rules, using a stop loss is strongly recommended."
                                    />
                                     <FaqItem
                                    ...
                                    />
                                     <FaqItem
                                        ...
                                        answer="Leverage is capped at whatever NSE/BSE permits under SEBI regulations — nothing more, nothing less. FundedStock does not offer any enhanced or additional leverage beyond what the exchange provides."
                                    />
                                     <FaqItem
