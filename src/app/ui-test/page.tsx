...
const GlassCard = ({
  ...
  <div
    className={cn(
      'bg-slate-800/30 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl',
      className
    )}
  >
    {children}
...
const Logo = () => (
    <div className="bg-slate-800 h-10 w-10 flex items-center justify-center rounded-lg text-2xl font-bold border border-white/10">
        N
    </div>
);
...
const DashboardHeader = () => (
  <header className="flex items-center justify-between mb-8">
    <div className="flex items-center gap-8">
        <Logo />
        <nav className="hidden md:flex items-center gap-1 bg-slate-900/50 border border-white/10 p-1 rounded-full">
            <a href="#" className="px-4 py-1.5 text-sm font-medium bg-slate-700/80 rounded-full text-white">
            Account Overview
            </a>
    ...
    <div className="flex items-center gap-2">
      <button className="h-9 w-9 flex items-center justify-center rounded-full hover:bg-slate-800/60 transition-colors">
      ...
      <div className="flex items-center gap-2 bg-slate-900/50 border border-white/10 p-1 rounded-full">
      ...
      <button className="h-9 w-9 flex items-center justify-center rounded-full hover:bg-slate-800/60 md:hidden transition-colors">
  ...
  <GlassCard className="p-6 col-span-1 md:col-span-2 relative overflow-hidden">
    ...
    <div className="relative">
        <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
            ...
            <div className="shrink-0 border border-white/10 bg-slate-900/50 rounded-full px-4 py-1.5 text-sm font-mono text-gray-300">
                78748803
            </div>
        </div>
...
const AccountDetails = () => {
  ...
  return (
    <GlassCard className="p-6 col-span-1 md:col-span-2 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top_left,rgba(168,85,247,0.15),transparent_50%)]"></div>
        <div className="relative">
            <h3 className="font-semibold mb-3 text-white tracking-wide">Account details</h3>
...
const StatCard = ({
  ...
  <GlassCard className="p-4 flex flex-col relative overflow-hidden">
    <div className="absolute -bottom-4 -right-4 text-white/5 opacity-50 text-[128px]">
        {decorativeIcon}
    </div>
  ...
  <div className="col-span-1 md:col-span-4 lg:col-span-1 space-y-6">
    <GlassCard className="p-6 text-center">
      ...
      <div className="my-6 flex justify-center">
        <div className="h-24 w-24 rounded-full bg-purple-500/10 flex items-center justify-center border-2 border-purple-500/50 shadow-[0_0_20px_rgba(168,85,247,0.3)]">
...
export default function UITestPage() {
  return (
    <div className="dark min-h-screen bg-[#0A0A0F] text-gray-200 font-sans relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-6">
          <div className="col-span-1 md:col-span-4 lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <StatCard
              ...
              decorativeIcon={<LineChart className="-scale-y-100"/>}
            />
            <StatCard
              title="Trade"
              value="$2760"
              ...
              progressColor="bg-purple-500/20 text-purple-300"
              decorativeIcon={<CandlestickChart />}
            />
          </div>
          <RightSidebar />
        </div>
